...
CREATE TABLE birth_certificate (
    ...
    father_profession VARCHAR(100) NOT NULL,
    father_residence VARCHAR(100) NOT NULL,
    mother_name VARCHAR(100) NOT NULL,
    mother_birth_date DATE NOT NULL,
    mother_birth_place VARCHAR(100) NOT NULL,
    mother_profession VARCHAR(100) NOT NULL,
    mother_residence VARCHAR(100) NOT NULL,
    drawn_on DATE NOT NULL,
    declarant_name VARCHAR(100) NOT NULL,
    declaration_attester_name VARCHAR(100) NOT NULL,
    civil_status_registrar VARCHAR(100) NOT NULL,
